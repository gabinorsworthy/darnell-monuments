...
<div class="section page-intro" id="jump-to">
    ...
    <div>
        <h1 class="section-title">Choosing your stone...</h1>
         
        <h4 class="description">
            The first step in choosing a stone is to decide the desired size, shape, and color. To start the process, we have
            pictures and descriptions of different kinds of stones below. We also suggest driving
            through a few cemeteries and looking for something you like. If you see
            ...
            For more details on choosing your stone, view our frequently asked questions or contact us directly.
        </h4>

        <button type="button" class="btn more-details" onclick="location.href='faq'">More Details</button>
...
<div>
    ...
    <div class="section reverse-section" id="cremation-memorials">
        ...
        <div class="section-text">
            <h1 class="section-title">Cremation Memorials</h1>
    ...
    <div class="section reverse-section" id="vases">
        ...
        <div class="section-text">
            <h1 class="section-title">Vases</h1>
