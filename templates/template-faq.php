...
<div class="section page-intro" id="jump-to">
    ...
    <div>
        ...
        <h4 class="description">
            We've taken the time to answer our customer's most frequently asked questions, including
            how to pick your stone, cemetery restrictions, and pricing and payment methods.
            If you still have questions after reading through the FAQs or would like additional details on a topic,
        ...
        <div class="card mb-3">
            ...
            <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="questionFour" data-parent="#faq">
                <h5 class="card-body">
                    ...
                    the monument that you want to purchase.
                </h5>
            </div>
        </div>
